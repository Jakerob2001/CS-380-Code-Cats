/**
* Main starting Driver class for sign in and access to all features including seperate user dashboards and new user registration
* @author Jake, Nathan 
*/
...
public class SignInPage extends JFrame {
	...
	*/
	...
	public SignInPage() {
		...
		gbc_txtPass.insets = new Insets(20, 0, 20, 5);
		...
		chkShowPass = new JCheckBox("Show");
		...
		btnSignUp.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				new SignUpPage(con, currentUser);
	...
	*/
	...
	/**
	* Function to populate check and create User from sign in details
	* @param username The entered usernma
